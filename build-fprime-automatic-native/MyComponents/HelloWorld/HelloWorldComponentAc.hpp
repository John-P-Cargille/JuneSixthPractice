...
namespace MyComponents {
  ...
  PROTECTED:
    ...
    enum {
      EVENTID_HELLO = 0x0, /* Greeting event with maximum greeting length of 20 characters */
    };
  ...
  PROTECTED:
    ...
    void log_ACTIVITY_HI_Hello(
        const Fw::LogStringArg& greeting /*!< Greeting supplied from the SAY_HELLO command*/
    );
  ...
  PROTECTED:
    ...
    enum {
      CHANNELID_GREETINGCOUNT = 0x0, //!< Channel ID for GreetingCount
    };
  ...
  PROTECTED:
    ...
    //! Write telemetry channel GreetingCount
    //!
    /* A count of the number of greetings issued */
    void tlmWrite_GreetingCount(
