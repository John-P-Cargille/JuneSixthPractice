...
namespace MyDeployment {
  ...
  const Svc::TlmPacketizerPacketList MyDeploymentPacketsPkts = {
      {
         &CDH,
         &CDHErrors,
         &DriveTlm,
  ...
  const Svc::TlmPacketizerPacket MyDeploymentPacketsIgnore = { ignoreList, 0, 0, FW_NUM_ARRAY_ELEMENTS(ignoreList) };

} // end namespace MyDeployment
